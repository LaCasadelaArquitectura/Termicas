...
export default [
  {
    id: 1,
    bgColor: "linear-gradient(90deg, rgba(112,0,0,1) 0%, rgba(217,107,23,1) 73%, rgba(255,195,53,1) 100%)",
  ...
  {
    id: 2,
    bgColor: "linear-gradient(90deg, rgba(112,0,0,1) 0%, rgba(217,23,23,1) 73%, rgba(255,53,53,1) 100%)",
    title: "Calefacción",
    textColor: "bg-gradient-to-r from-black via-red-800 to-red-500  text-transparent bg-clip-text",
  },
  {
    id: 3,
    bgColor: "linear-gradient(90deg, rgba(198,20,20,1) 19%, rgba(120,31,56,1) 50%, rgba(26,25,189,1) 81%)",
    title: "ACS y Suministro de Agua",
    desc:
      ""
  },
  {
    id: 4,
    bgColor: "linear-gradient(90deg, rgba(0,31,184,1) 18%, rgba(0,159,255,1) 65%, rgba(106,180,252,1) 95%)",
    title: "Climatización",
    desc:
      ""
  },
  {
    id: 5,
    bgColor: "linear-gradient(90deg, rgba(42,124,184,1) 18%, rgba(101,228,255,1) 65%, rgba(151,226,255,1) 95%)",
    title: "Refrigeración",
    desc:
      ""
  },
  {
    id: 5,
    bgColor: "linear-gradient(90deg, rgba(0,174,184,1) 18%, rgba(0,255,201,1) 65%, rgba(106,252,238,1) 95%)",
    title: "Ventilación",
    desc:
      ""
  }
